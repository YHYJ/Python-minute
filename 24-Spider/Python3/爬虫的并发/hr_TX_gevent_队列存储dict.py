...
class TXSpider:
    ...
    def parse_data(self, html_data):
        ...
        for node in node_list:
            ...
            item["职位名"] = position_name
            item["链接"] = position_link
            item["职位类别"] = position_type
            item["招聘人数"] = position_num
            item["工作地点"] = position_site
            item["发布时间"] = position_time

            self.data_queue.put("{}".format(item))
